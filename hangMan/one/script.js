window.onload = function () {
  ...
  // Hint
    ...
    hint.onclick = function() {
      ...
      hints = [
        ["Powstała z rozpadu Czechosłowacji", ".... gurom", "Byłym prezydentem jest facet z tupecikiem", "Wyszła niedawno z Unii Europejskiej", "Są sławni ze swoich kiełbas"],
        ...
        ["Ulubiona gra nauczyciela wychowawcy 2GT (stan na rok 2021)", "Przygody walecznego torbacza", "Najlepszy hydraulik we wszechświcie", "Najpopularniejsza sowiecka gra", "Nie działa ...."],
